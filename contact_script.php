...
if ( $validationFailed === false ) {
 ...
 $emailSubject = FilterCChars("Contact Form Request");
 ...
 $emailBody = "Name : $FTGname\n"
  ...
  . "";
  $emailTo = 'larry@larryjophoto.com';
   
  $emailFrom = FilterCChars("customer@contact.com");
...
header("Location: http://larryfinnphotography.com/thank_you.php");
