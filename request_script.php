...
if (!CheckString($FTGname, 2, 35, kStringRangeBetween, kYes, kNo, kYes, '', kMandatory)) {
 $FTGErrorMessage['name'] = 'Enter a valid name';
 $validationFailed = true;
}

if (!CheckEmail($FTGemail_address, kMandatory)) {
 $FTGErrorMessage['email_address'] = 'Enter a valid email';
 $validationFailed = true;
}
...
if ( $validationFailed === false ) {
 ...
 $emailSubject = FilterCChars("Online Service Request");
 ...
 $emailBody = "Name : $FTGname\n"
  ...
  . "";
  $emailTo = 'MIke <mike@katyplumbing.com>';
   
  $emailFrom = FilterCChars("customer@request.com");
...
header("Location: http://www.katyplumbing.com/thank_you.php");
